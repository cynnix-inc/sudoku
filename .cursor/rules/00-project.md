...
When to use: planning features, creating folders, onboarding, prioritizing work
...
- Language/framework minutiae (see `20-style-guide.md`).
- Layering and import rules (see `10-architecture.md`).

Priority

- If rules conflict, this file wins over `20-style-guide.md` and `10-architecture.md`.
...
- Update Sudoku logic: put pure helpers in `app/game/` and cover with unit tests.
